...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { active: @bet.active, client_id: @bet.client_id, potentialWin: @bet.potentialWin, sucessful: @bet.sucessful, value: @bet.value }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { active: @bet.active, client_id: @bet.client_id, potentialWin: @bet.potentialWin, sucessful: @bet.sucessful, value: @bet.value }
    assert_redirected_to bet_path(assigns(:bet))
  end
